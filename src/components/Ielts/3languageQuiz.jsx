...
const IeltsQuiz = () => {
  ...
  const { examType,targetBand,currentLevel,takenBefore,previousBand,weakestSkill,timeAvailable,currentPart, quizprompt } = location.state;
  ...
  const handleFinish = () => {
    navigate("/ielts-result", {
      state: { userAnswers, correctAnswers, questions, currentPart, examType,targetBand,currentLevel,takenBefore,previousBand,weakestSkill,timeAvailable },
    });
  };
  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-br from-[var(--primary-black)] via-[var(--primary-violet)]/30 to-[var(--primary-black)] text-white py-10 px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        {/* Main Content */}
        <div className="bg-gradient-to-br from-[var(--primary-black)]/80 to-[var(--primary-violet)]/20 p-4 rounded-xl shadow-2xl border border-[var(--accent-teal)]/10 backdrop-blur-sm mb-8">
          {loading ? (
            ...
            <>
              ...
              {/* Question */}
              <div className="mb-8">
                <div className="p-2 bg-[var(--primary-black)]/40 rounded-lg border border-[var(--accent-teal)]/20 mb-6">
