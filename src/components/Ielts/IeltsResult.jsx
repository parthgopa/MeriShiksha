...
`;
    ...
    if (newPrompt && parts && nextPart)
      
      navigate("/ielts-learning-parts", { state: data2 });
  };
  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-br from-[var(--primary-black)] via-[var(--primary-violet)]/30 to-[var(--primary-black)] text-white py-10 px-6 relative overflow-hidden" id="Container">
      {/* Decorative elements */}
