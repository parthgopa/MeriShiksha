...
const LanguageChat = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[var(--primary-black)] via-[var(--primary-violet)]/30 to-[var(--primary-black)] text-white py-6 px-4 relative overflow-hidden">
      {/* Decorative elements */}
