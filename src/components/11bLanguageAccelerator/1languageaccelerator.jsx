        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-teal-100 max-w-3xl mx-auto">
              Rapidly improve your vocabulary and speaking skills through
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-4">
                    <p className="text-teal-100">
                      Our AI language mentor will engage you in interactive
                      conversations to rapidly improve your vocabulary and
                      speaking skills in your chosen language.
                    </p>
                    ...
                    <div className="pt-2">
                      <p className="text-sm text-teal-100/70 mb-2">
                        Popular choices:
                      </p>
                    ...
                    <div className="mt-4 p-4 bg-[var(--primary-black)]/40 rounded-lg border border-[var(--accent-teal)]/10">
                      <h3 className="text-lg font-medium text-[var(--accent-teal)] mb-2">
                        What you'll get:
                      </h3>
                      <ul className="space-y-2 text-sm text-teal-100">
                        <li className="flex items-start">
                          ...
                          <span>
                            Interactive conversation practice with AI mentor
                          </span>
                        </li>
                        <li className="flex items-start">
                          <svg
