...
const Functionalities = () => {
  ...
  const pages = [
    ...
    },
    {
      ...
      description: "Generate customized assessments",
      path: "/generate-mcqs",
      category: "Empowering Tutor"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-[var(--primary-black)] overflow-x-hidden">
      {/* Header */}
      <header className="bg-[var(--primary-black)] text-white py-4 px-6 flex justify-between items-center sticky top-0 z-50 border-b border-gray-800">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[var(--accent-teal)] to-[var(--primary-violet)]">
            Meri Shiksha
          </h1>
        </div>
        <nav>
